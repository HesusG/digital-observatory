...
export function VersionIndicator(_props: VersionIndicatorProps) {
  return (
    <div className="absolute top-40 left-1/2 -translate-x-1/2 z-20 pixel-panel px-14 py-7 select-none pointer-events-none flex flex-col items-center text-center gap-2">
